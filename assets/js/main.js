...
function toggleFeature(tabNumber) {
  readTab(tabNumber);
}

// function readTab(currentTab) {
//   var features = document.querySelectorAll(".core-feature-item");
//   for (var i = 0; i < features.length; i++) {
//     features[i].classList.add("hidden");
//   }
  
//   var featureId = "core-feature-" + currentTab;
//   var featureBlock = document.getElementById(featureId);
//   featureBlock.classList.remove("hidden");
